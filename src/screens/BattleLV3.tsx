    ...
    const newTeam2: PokemonType[] = [
      {
        ...
        scale: [1.5, 1.5, 1.5],
        currentAnimation: 'UmbreonLowPoly',
        moves: [
          {
            moveName: 'Tackle',
            damages: 15
          ...
          {/* Checks if the battle state exists then displays the Pokémon moves with their parameters contained in the battle global state */}
          {
            (
              ...
              <div className='grid grid-cols-2 gap-4 p-4'>
                {battle?.team1[0].moves.slice(0, 4).map((m: MoveType, i: number) => (
                  <RecoilBridge key={i}>
            ...
            <div className='absolute inset-0 flex p-11 items-start justify-center animate-pulse hover:animate-none'>
                  ...
                  <p> testd,jadpodkadakkakdapokadkakdkakdkakdkpdkoadkpakpdakdkkkdakdkakdakdko</p>
                </div>
              ...
              {/* Checks if the battle state exists then displays the Pokémon 3d animations with their parameters contained in the battle global state */}
              {
                (
                  ...
                  <>
                    {/* That is not possible to load an animation just with its file name, you need to display or hide it */}
                    {
                      battle?.team2[0].currentAnimation === 'UmbreonLowPoly'
                      ?
                      <Animation
                        title='UmbreonLowPoly'
